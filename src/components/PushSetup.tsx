 ...
 * `applicationServerKey` de PushManager.subscribe(). Retorno tipado sobre
 * ArrayBuffer concreto (no ArrayBufferLike) para satisfacer el tipo BufferSource
 * en el build strict de Next.
 */
